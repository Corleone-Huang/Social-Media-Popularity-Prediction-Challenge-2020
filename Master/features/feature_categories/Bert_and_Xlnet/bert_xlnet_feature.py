...
default_data_dir = '../../../data/data_source/train/train_tags.json'
default_save_title_feature = '../../extracted_features/'
default_save_alltags_feature = '../../extracted_features/'
...
def parse_args():
    ...
    parser.add_argument('--ngpu', default=2, type=int, dest='ngpu', 
                        help='使用的GPU数目')
...
if __name__ == "__main__":
    ...
    '''
    MODELS_LIST = [(BertModel,       BertTokenizer,       'bert-base-uncased')]
    text_dataset = TextDataset(json_file_path='../../../smp/SMP2020_test/test_tags.json')
