...
# save pid,uid,feature1,...,feature2048
...
train_image_root_path = "../../../data/data_source/train/train_image/"
train_temporalspatial_filepath = "../../../data/data_source/train/train_temporalspatial.json"
train_category_filepath= "../../../data/data_source/train/train_category.json"
test_image_root_path = "../../../data/data_source/test/SMP_test_images/"
test_temporalspatial_filepath = "../../../data/data_source/test/test_temporalspatial.json"
test_category_filepath = "../../../data/data_source/test/test_category.json"
...
def parse_arguments():
    ...
    parser.add_argument("--finetune_category_feature_filepath", type=str,
                        default=finetune_category_feature_filepath,
    ...
    parser.add_argument("--finetune_subcategory_feature_filepath", type=str,
                        default=finetune_subcategory_feature_filepath,
