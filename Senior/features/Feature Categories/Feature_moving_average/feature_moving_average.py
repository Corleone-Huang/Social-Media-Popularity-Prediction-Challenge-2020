...
parser.add_argument('-d', '--data_dir',
                    ...
                    default="/home/wangkai/SMP/feature/all_feature/Glove_tags_486194.csv", type=str)
parser.add_argument('-o', '--output_dir',
                    help='The path of output data.',
                    default="/home/wangkai/SMP/feature/all_feature/Glove_tags_486194_average_5.csv",
                    type=str)
parser.add_argument('-n', '--n_window',default=5,
                    help='The number of feature to conduct moving average.', type=int, choices=[3, 5])
args = parser.parse_args(args=[])

with open('/home/wph/SMP/data/train_temporalspatial.json') as f:
    timespetio1 = pd.read_json(f)
with open("/home/smp/SMP2020_test/test_temporalspatial.json") as fi:
    timespetio2 = pd.read_json(fi)

# with open('/home/wph/SMP/data/train_temporalspatial.json') as f:
#     timespetio1 = json.load(f)
...
# 按照时序对特征进行排�?df = pd.read_csv(args.data_dir, index_col='pid')
print(df)
df = df.loc[index_pid]
uids = df['uid']
...
df.iloc[:305613,:].to_csv("/home/wangkai/SMP/feature/train_feature/Glove_tags_305613_average_5.csv",index=False)
df.iloc[305613:,:].to_csv("/home/wangkai/SMP/feature/test_feature/Glove_tags_180581_average_5.csv",index=False)
print('Done!')
t2 = time.time()
