...
def parse_args():
    ...
    parser.add_argument('--data_path', default='/home/cx/SMP/data/train/train_tags.json',
                        dest='data_path',type=str, help='文本json数据的路径')
    parser.add_argument('--save_title', default='/home/cx/SMP/data/测试特征/pca_onehot_title_10000-256.csv',
