...
csv_data.columns = ['tag']
csv_df = pd.DataFrame(csv_data['tag'])

# removing everything except alphabets`
csv_df['clean_doc'] = csv_df['tag'].str.replace("[^a-zA-Z#]", " ")
...
# This is the first step towards topic modeling. We will use sklearn's TfidfVectorizer
# to create a document-term matrix with 1000 words.
